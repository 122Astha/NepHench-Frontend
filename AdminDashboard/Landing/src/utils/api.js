...
const api = axios.create({
    baseURL: "http://192.168.52.87:9096/api/",
    headers: {
...
export const getDataFromApi = async (uri) => {
    const dataFromApi = await api.get(uri)
        .then(res => res.data)
    return dataFromApi
}
...
export const postDataToApi = async (uri, data) => {
    const newCreatedData = await api.post(uri, data)
        .then(res => res.data)
...
export const updateDataToApi = async (uri, data, id) => {
    const updatedData = await api.patch(`${uri}/${id}`, data)
        .then(res => res.data)
...
export const updatesDataToApi = async (uri, data, id) => {
    const updatedData = await api.put(`${uri}/${id}`, data)
        .then(res => res.data)
