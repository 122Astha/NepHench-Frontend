  ...
  return (
    <>
      <UserBoxButton color="secondary" ref={ref} onClick={handleOpen}>
        <Avatar variant="rounded" alt={adminRecord} src={base64Image2} />
        <Hidden mdDown>
          <UserBoxText>
            <UserBoxLabel variant="body1">{adminRecord}</UserBoxLabel>
      ...
      >
        <MenuUserBox sx={{ minWidth: 210 }} display="flex">
          <Avatar variant="rounded" alt={user.name} src={base64Image2} />
          <UserBoxText>
            <UserBoxLabel variant="body1">{adminRecord} </UserBoxLabel>
            <UserBoxDescription variant="body2">
              {adminEmail}
        ...
        <Divider />
        <Box sx={{ m: 1 }}>
          <Button color="primary" fullWidth to="/login" component={NavLink}>
